...
return {
...

    {
        ...
        opts = {
            ...
            on_colors = function(colors)
                ...
                -- (Truncated for brevity, but keep your custom colors here in your actual file!)
            end,
        },
    },

    {
        ...
        opts = {
            ...
            -- (Keep your custom overrides here!)
        },
    },

    {
        ...
        config = function()
            ...
            -- REMOVED: vim.cmd("colorscheme kanagawa")
        end,
    },
...

    {
        ...
        config = function()
            require("lume").setup()
            -- REMOVED: vim.cmd("colorscheme lume")
        end,
    },
