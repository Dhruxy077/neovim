...
-- Provide a default comment string for files that don't have one
vim.api.nvim_create_autocmd("BufEnter", {
	pattern = "*",
	callback = function()
		if vim.bo.commentstring == "" then
			vim.bo.commentstring = "# %s" -- Defaults to bash/python style so it doesn't crash
		end
	end,
	desc = "Fallback commentstring",
})
